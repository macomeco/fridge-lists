...
$(document).on('turbolinks:load', function() {
  ...
  //////////// tng_edit ////////////
  $(function(){
      $(document).on('click', '.tng-edit',function(){
